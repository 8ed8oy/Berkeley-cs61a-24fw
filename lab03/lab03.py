...
def double_eights(n: int) -> bool:
    ...
    True
    """
    return True if n % 100 == 88 else n > 10 and double_eights(n // 10)
...
def ten_pairs(n):
    ...
    True
    """
    return 0 if n < 10 else count_digit(n // 10, 10 - n % 10) + ten_pairs(n // 10)
...
def count_digit(n, digit):
    ...
    True
    """
    return 1 if n == digit else 0 if n < 10 else count_digit(n // 10, digit) + (1 if n % 10 == digit else 0)
