...
def num_eights(n):
    ...
    True
    """
    return num_eights(n // 10) + (1 if n % 10 == 8 else 0) if n > 0 else 0
...
def digit_distance(n):
    ...
    True
    """
    return abs(n % 10 - (n // 10) % 10) + digit_distance(n // 10) if n >= 10 else 0
...
def interleaved_sum(n, f_odd, f_even):
    ...
    True
    """
    def fxxk(i, n, f_odd, f_even):
        if i < n:
            return f_odd(i) + f_even(i + 1) + fxxk(i + 2, n, f_odd, f_even)
        elif i == n:
            return f_odd(i) 
        else:
            return 0
    return fxxk(1, n, f_odd, f_even)
